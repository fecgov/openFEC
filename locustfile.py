...
small_records_sched_a = [
    ...
    {"contributor_name": "Farnsworth"},
    {"contributor_name": "Beaufort"},
    {"contributor_name": "Karny"},
]
...
class Tasks(locust.TaskSet):
    ...
    def test_download(self):
        ...
        params = {
            ...
            "two_year_transaction_period": get_random_cycle(),
            "min_date": rand_date,
            "max_date": rand_date,
            "sort": "-contribution_receipt_date",
            "is_individual": True,
    ...
    def load_schedule_a_small(self):
        ...
        params["two_year_transaction_period"] = get_random_cycle()
        params["api_key"] = API_KEY
