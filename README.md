...
1. Ensure you have the following requirements installed:
   ...
   - Flyway 10.12.0 ([homebrew instructions](https://formulae.brew.sh/formula/flyway))

     - After downloading, create a .toml file in the following location: `flyway-10.12.0/conf/flyway.toml` and set the flyway environment variables `environment`, `url`, `user`, `password` and`locations` as
