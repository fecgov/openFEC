...
# ---------------------- Start all case filters  ------------------------------------------------
    def test_all_doc_types(self):
        response = self._response(api.url_for(UniversalSearch))
        # logging.info(response)
    ...
    def test_case_no(self):
        ...
        response = self._response(api.url_for(UniversalSearch, case_no=case_numbers))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, case_no="105"))
        # logging.info(response)
    ...
    def test_case_doc_cat_id_filter(self):
        ...
        response = self._response(api.url_for(UniversalSearch, case_doc_category_id=case_doc_category_ids))
        # logging.info(response)
    ...
    def test_case_doc_date(self):
        ...
        response = self._response(api.url_for(UniversalSearch, case_min_document_date=document_date))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, case_max_document_date=document_date))
        # logging.info(response)
    ...
    def test_q_filters(self):
        ...
        response = self._response(api.url_for(UniversalSearch, q=search_phrase))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, q_exclude=exclude_phrase))
        # logging.info(response)
...
# ---------------------- Start MUR and ADR filters ------------------------------------------------
    def test_election_cycles_filter(self):
        ...
        election_cycle = 2020
        response = self._response(api.url_for(UniversalSearch, case_election_cycles=election_cycle))
        # logging.info(response)
    ...
    def test_case_date_filters(self):
        ...
        response = self._response(api.url_for(UniversalSearch, case_min_open_date=open_date))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, case_max_open_date=open_date))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, case_min_close_date=close_date))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, case_max_close_date=close_date))
        # logging.info(response)
    ...
    def test_subject_id(self):
        ...
        response = self._response(api.url_for(UniversalSearch, primary_subject_id=primary))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, secondary_subject_id=secondary))
        # logging.info(response)
    ...
    def test_case_respondents(self):
        ...
        for respondent in respondents:
            response = self._response(api.url_for(UniversalSearch, case_respondents=respondent))
            # logging.info(response)
...
# ---------------------- Start MUR only filters ------------------------------------------------
    ...
    def test_mur_citation_filters(self):
        ...
        response = self._response(api.url_for(UniversalSearch, case_statutory_citation=stat_citation,
    ...
    def test_mur_disposition_filter(self):
        # filter for current murs only
        categories = ["7", "24"]
        response = self._response(api.url_for(UniversalSearch, mur_disposition_category_id=categories))
        # logging.info(response)
        ...
        category = "14"
        response = self._response(api.url_for(UniversalSearch, mur_disposition_category_id=category))
        # logging.info(response)
...
# ---------------------- Start AF only filters ------------------------------------------------
    def test_af_name_multiple_filter(self):
        ...
        response = self._response(api.url_for(UniversalSearch, af_name=names_list))
        # logging.info(response)
    ...
    def test_af_date_filters(self):
        ...
        response = self._response(api.url_for(UniversalSearch, af_min_rtb_date=rtb))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, af_max_rtb_date=rtb))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, af_min_fd_date=fd_date))
        # logging.info(response)
        ...
        response = self._response(api.url_for(UniversalSearch, af_max_fd_date=fd_date))
        # logging.info(response)
