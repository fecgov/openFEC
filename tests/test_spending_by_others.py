...
# Test endpoint: '/schedules/schedule_e/all_candidates/support_oppose_totals/'
# (spending_by_others.py.ScheduleESupportOpposeTotalsView) under tag:Independent expenditures
class TestScheduleESupportOpposeTotals(ApiBaseTest):
    ...
    def setUp(self):
        ...
        factories.ScheduleESupportOpposeTotalsFactory(
                ...
                candidate_state='US',
                candidate_district='00',
                support_oppose_indicator='Other',
                ie_total=4000
            ),
        factories.ScheduleESupportOpposeTotalsFactory(
                cycle=2010,
    ...
    def test_filter_by_support_oppose(self):
        results = self._results(api.url_for(ScheduleESupportOpposeTotalsView, support_oppose='Other'))
