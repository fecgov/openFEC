...
CREATE TABLE f_rpt_or_form_sub_vw (
    ...
    report_pgi text,
    amend_ind text
) SERVER rds OPTIONS (schema_name 'public', table_name 'f_rpt_or_form_sub_vw');
...
CREATE TABLE form_7 (
    ...
    load_date timestamp without time zone NOT NULL,
    update_date timestamp without time zone
)  SERVER rds OPTIONS (schema_name 'public', table_name 'form_7');
...
CREATE TABLE vw_filing_history(
     ...
     record_ind text,
     update_date timestamp without time zone
 )  SERVER rds OPTIONS (schema_name 'public', table_name 'vw_filing_history');
