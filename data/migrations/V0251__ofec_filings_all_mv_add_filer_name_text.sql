...
Add one tsvector fulltext column : filer_name_text and idx_ofec_filings_all_mv_filer_name_text
into public.ofec_filings_all_mv

-- Previous mv is V0224
*/
-- ----------
...
SELECT row_number() OVER () AS idx,
    ...
    to_tsvector(parse_fulltext(com.name)) as filer_name_text
