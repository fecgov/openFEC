...
cand_info AS (
    SELECT DISTINCT ON (cand_audit_vw.cand_id, cand_audit_vw.fec_election_yr)
        cand_audit_vw.cand_id,
...
drop materialized view if exists ofec_audit_case_category_rel_mv;
...
drop materialized view if exists ofec_audit_case_sub_category_rel_mv;
