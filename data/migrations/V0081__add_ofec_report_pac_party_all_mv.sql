...
CREATE INDEX ofec_report_pac_party_all_mv_independent_expenditures_per_idx1
  ON public.ofec_report_pac_party_all_mv
  USING btree
  (independent_expenditures_period, idx);
 
 
CREATE INDEX ofec_report_pac_party_all_mv_total_disbursements_period_id_idx
  ON public.ofec_report_pac_party_all_mv
  USING btree
...
CREATE INDEX ofec_report_pac_party_all_mv_cycle_committee_id_idx1
  ON public.ofec_report_pac_party_all_mv
  USING btree
...
CREATE INDEX ofec_report_pac_party_all_mv_is_amended_idx_idx1
  ON public.ofec_report_pac_party_all_mv
  USING btree
  (is_amended, idx); 
