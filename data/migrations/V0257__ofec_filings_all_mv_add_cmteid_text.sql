/*
For issue #5220
This is the latest version of ofec_filings_all_mv
Add committee ID to tsvector column and rename column 

Previous version is V0251
*/
-- ----------
...
SELECT row_number() OVER () AS idx,
    ...
    to_tsvector(parse_fulltext(com.name||' '||filing_history.cand_cmte_id)) AS filer_name_text
