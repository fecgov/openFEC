...
WITH totals AS (
         ...
         SELECT cycle_cmte_totals_basic.cand_id AS candidate_id,
            ...
            sum(cycle_cmte_totals_basic.other_receipts) AS other_receipts
         ...
         SELECT cycle_cmte_totals.candidate_id,
            ...
            sum(cycle_cmte_totals.other_receipts) AS other_receipts
         ...
         SELECT cycle_cmte_totals.candidate_id,
            ...
            cycle_cmte_totals.other_receipts
           FROM cycle_cmte_totals
         ...
         SELECT election_cmte_totals_basic.candidate_id,
            ...
            sum(election_cmte_totals_basic.other_receipts) AS other_receipts
         ...
         SELECT election_cmte_totals.candidate_id,
            ...
            sum(election_cmte_totals.other_receipts) AS other_receipts
 ...
 -- --
    ...
    COALESCE(totals.other_receipts, 0::numeric) AS other_receipts
...
CREATE INDEX idx_ofec_candidate_totals_mv_tmp_other_receipts ON public.ofec_candidate_totals_mv_tmp USING btree (other_receipts);
