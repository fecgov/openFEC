/*
1. This migration file is for #5347
2. Parsed candidate names are added to this 
3. Previous vision V0179
*/
...
SELECT row_number() OVER () AS idx,
	...
	cname.cand_nm_first as candidate_first_name,
    cname.cand_m_nm as candidate_middle_name,
    cname.cand_nm_last as candidate_last_name,
    cname.cand_prefix as candidate_prefix,
    cname.cand_suffix as candidate_suffix
FROM fec_yr
...
LEFT JOIN candidate_firstlast_name_vw cname ON fec_yr.cand_id = cname.cand_id AND fec_yr.election_year = cname.election_yr
WHERE cycles.max_cycle >= 1979 AND NOT (fec_yr.cand_id::text IN 
