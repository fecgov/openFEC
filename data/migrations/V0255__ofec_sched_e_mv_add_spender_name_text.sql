...
Add one tsvector fulltext column : spender_name_text
Add idx_ofec_sched_e_mv_spender_name_text in public.ofec_sched_e_mv

-- Previous migration file is V0173__add_most_recent_to_ofec_sched_e_mv.sql
*/
...
most_recent,
to_tsvector(parse_fulltext(se.cmte_nm)) as spender_name_text
FROM se
