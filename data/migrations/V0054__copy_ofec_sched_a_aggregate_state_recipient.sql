-- redefine MATERIALIZED VIEW public.ofec_sched_a_aggregate_state_recipient_totals_mv to use staging.ref_zip_to_district instead of previous ofec_fips_states CSV file
...
CREATE INDEX ofec_sched_a_aggregate_state_recip_committee_type_full_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (committee_type_full COLLATE pg_catalog."default", idx);


CREATE INDEX ofec_sched_a_aggregate_state_recipient__committee_type_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (committee_type COLLATE pg_catalog."default", idx);


CREATE INDEX ofec_sched_a_aggregate_state_recipient_tota_state_full_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (state_full COLLATE pg_catalog."default", idx);


CREATE INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_count_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (count, idx);
...
CREATE UNIQUE INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_tmp_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (idx);


CREATE INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_total_idx_TMP
  ON public.ofec_sched_a_aggregate_state_recipient_totals_mv_TMP
  USING btree
  (total, idx);
...
ALTER INDEX ofec_sched_a_aggregate_state_recipient_tota_state_full_idx_tmp RENAME TO ofec_sched_a_aggregate_state_recipient_tota_state_full_idx;

ALTER INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_count_idx_tmp RENAME TO ofec_sched_a_aggregate_state_recipient_totals_mv_count_idx;
...
ALTER INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_tmp_idx_tmp RENAME TO ofec_sched_a_aggregate_state_recipient_totals_mv_idx;

ALTER INDEX ofec_sched_a_aggregate_state_recipient_totals_mv_total_idx_tmp RENAME TO ofec_sched_a_aggregate_state_recipient_totals_mv_total_idx;
