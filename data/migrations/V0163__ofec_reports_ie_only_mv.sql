...
public.fec_vsum_f5_vw is currently been used by the following MV:
public.ofec_reports_ie_only_mv

public.ofec_reports_ie_only_mv is redefined to use 
the base tables of public.fec_vsum_f5_vw so it will 
1) reduce the dependency layer
2) public.fec_vsum_f5_vw can be recreated to correct the "unknown" data type issue 
