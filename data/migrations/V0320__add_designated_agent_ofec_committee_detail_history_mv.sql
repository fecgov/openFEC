/*
This migration file is for #6546

1) Add 13 Designated Agent fields from public.fec_vsum_f1_vw to 
ofec_committee_history_mv 
ofec_committee_history_vw
...
2) Add 13 Designated Agent fields from public.fec_vsum_f1_vw to 
ofec_committee_detail_mv
ofec_committee_detail_vw
...
-- 1) Add 13 Designated Agent fields from public.fec_vsum_f1_vw to ofec_committee_history_mv and ofec_committee_history_vw
...
SELECT DISTINCT ON (fec_yr.cmte_id, fec_yr.fec_election_yr) row_number() OVER () AS idx,
    ...
    f1.designated_agent_nm AS designated_agent_name,
    f1.designated_agent_l_nm AS designated_agent_last_name,
    f1.designated_agent_f_nm AS designated_agent_first_name,
    f1.designated_agent_m_nm AS designated_agent_middle_name,
    f1.designated_agent_prefix,
    f1.designated_agent_suffix,
    f1.designated_agent_st1 AS designated_agent_street1,
    f1.designated_agent_st2 AS designated_agent_street2,
    f1.designated_agent_city,
    f1.designated_agent_st AS designated_agent_state,
    f1.designated_agent_zip,
    f1.designated_agent_title,
    f1.designated_agent_ph_num AS designated_agent_phone_number
...
-- 2) Add 13 Designated Agent fields from public.fec_vsum_f1_vw to ofec_committee_detail_mv and ofec_committee_detail_vw
-- ----------
-- ofec_committee_detail_mv
-- ----------
...
SELECT DISTINCT ON (ofec_committee_history_vw.committee_id) ofec_committee_history_vw.idx,
    ...
    ofec_committee_history_vw.designated_agent_name,
    ofec_committee_history_vw.designated_agent_last_name,
    ofec_committee_history_vw.designated_agent_first_name,
    ofec_committee_history_vw.designated_agent_middle_name,
    ofec_committee_history_vw.designated_agent_prefix,
    ofec_committee_history_vw.designated_agent_suffix,
    ofec_committee_history_vw.designated_agent_street1,
    ofec_committee_history_vw.designated_agent_street2,
    ofec_committee_history_vw.designated_agent_city,
    ofec_committee_history_vw.designated_agent_state,
    ofec_committee_history_vw.designated_agent_zip,
    ofec_committee_history_vw.designated_agent_title,
    ofec_committee_history_vw.designated_agent_phone_number 
