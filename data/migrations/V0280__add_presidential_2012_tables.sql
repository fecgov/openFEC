...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_nml_ca_cm_link_12d
(
...
,CONSTRAINT pres_nml_ca_cm_link_12d_pkey PRIMARY KEY (pr_link_id)
)
WITH (OIDS=FALSE)');
	EXCEPTION 
...
ALTER TABLE disclosure.pres_nml_ca_cm_link_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_nml_ca_cm_link_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_nml_ca_cm_link_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_ca_cm_sched_a_join_12d
(
 cand_id	varchar(9)	
 ,contbr_st	varchar(2)	
 ,zip_3	varchar(3)	
...
ALTER TABLE disclosure.pres_ca_cm_sched_a_join_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_ca_cm_sched_a_join_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_ca_cm_sched_a_join_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_ca_cm_sched_state_12d
(
 cand_id	varchar(9)	
 ,contbr_st	varchar(2)	
 ,cand_pty_affiliation	varchar(3)	
...
ALTER TABLE disclosure.pres_ca_cm_sched_state_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_ca_cm_sched_state_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_ca_cm_sched_state_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_ca_cm_sched_link_sum_12d
(
...
ALTER TABLE disclosure.pres_ca_cm_sched_link_sum_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_ca_cm_sched_link_sum_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_ca_cm_sched_link_sum_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_nml_sched_a_12d
(
 ...
 ,pg_date timestamp NULL DEFAULT now()
,CONSTRAINT pres_nml_sched_a_12d_pkey PRIMARY KEY (record_id)
)
WITH (OIDS=FALSE)');
	EXCEPTION 
             WHEN duplicate_table THEN 
...
ALTER TABLE disclosure.pres_nml_sched_a_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_nml_sched_a_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_nml_sched_a_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_nml_sched_b_12d
(
 file_num	numeric(7,0)	
 ,cmte_id	varchar(9)	
 ,cand_id	varchar(9)	
 ...
 ,election_tp	varchar(5)	
 ,pg_date timestamp NULL DEFAULT now()
 ,CONSTRAINT pres_nml_sched_b_12d_pkey PRIMARY KEY (record_id)
)
WITH (OIDS=FALSE)');
	EXCEPTION 
             WHEN duplicate_table THEN 
...
ALTER TABLE disclosure.pres_nml_sched_b_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_nml_sched_b_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_nml_sched_b_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_f3p_totals_ca_cm_link_12d
(
 pr_link_id	numeric(12,0)	NOT NULL
 ,cmte_id	varchar(9)	
 ,cmte_nm	varchar(200)	
...
ALTER TABLE disclosure.pres_f3p_totals_ca_cm_link_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_f3p_totals_ca_cm_link_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_f3p_totals_ca_cm_link_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_nml_f3p_totals_12d
(
 ...
 ,indv_unitem_contb_per	numeric(14,2)	
 ,pg_date timestamp NULL DEFAULT now()
,CONSTRAINT pres_nml_f3p_totals_12d_pkey PRIMARY KEY (cand_id,election_yr)
)
WITH (OIDS=FALSE)');
	EXCEPTION 
             WHEN duplicate_table THEN 
...
ALTER TABLE disclosure.pres_nml_f3p_totals_12d OWNER TO fec;
GRANT ALL ON TABLE disclosure.pres_nml_f3p_totals_12d TO fec;
GRANT SELECT ON TABLE disclosure.pres_nml_f3p_totals_12d TO fec_read;
...
DO $$
BEGIN
	EXECUTE format('CREATE TABLE disclosure.pres_nml_form_3p_12d
(
 file_num	numeric(7,0)	
 ...
 ,pg_date timestamp NULL DEFAULT now()
 ,CONSTRAINT pres_nml_form_3p_12d_pkey PRIMARY KEY (record_id)
)
WITH (OIDS=FALSE)');
	EXCEPTION 
             WHEN duplicate_table THEN 
