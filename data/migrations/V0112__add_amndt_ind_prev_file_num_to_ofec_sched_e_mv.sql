/*
Issue #3448: Add the following two columns to ofec_sched_e_mv
amndt_ind,
prev_file_num
*/

-- create a tmp version of the MV first
...
-- -----------------------------------------------
-- public.ofec_sched_e_vw depends on public.ofec_sched_e_mv.  It is not used by API yet.  Just drop and recreated
