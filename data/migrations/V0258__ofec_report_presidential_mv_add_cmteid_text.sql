/*
For issue #5220
This is the latest version of ofec_reports_presidential_mv
Add committee ID to tsvector column and rename column 

Previous version is V0252
*/
-- -----------------------------------------------------
...
CREATE MATERIALIZED VIEW public.ofec_reports_presidential_mv_tmp AS
  SELECT row_number() OVER () AS idx,
    ...
    to_tsvector(parse_fulltext(cmte.cmte_nm||' '||f3p.cmte_id)) AS filer_name_text
