/*
This is to solve issue #4054 (API issue #3817).
Add the follow column.
filing_date (indexes added since this field will be used for filter)
Note:  receipt_dt in form and in schedule are not always the same.  
Use the receipt_dt of the form.
*/
