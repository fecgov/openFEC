...
-- drop indexes
DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_sub_id_date_amount;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_cmte_id;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_cmte_nm;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_cmte_tp;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_cmte_dsgn;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_event_purpose_date;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_disbursement_amount;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_cycle;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_sub_id;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_payee_city;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_payee_state;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_payee_zip;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_disbursement_purpose;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_disbursement_purpose_text;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_payee_name;

DROP INDEX IF EXISTS idx_ofec_sched_h4_mv_tmp_payee_name_text;
