/*
1. This migration file is for #60847
2. Parsed candidate names are added to this 
3. Previous vision V0141
*/
...
CREATE MATERIALIZED VIEW public.ofec_candidate_detail_mv_tmp AS 
 ...
 SELECT DISTINCT ON (cand_hist.candidate_id) cand_hist.idx,
	...
	cand_hist.candidate_first_name as candidate_first_name,
    cand_hist.candidate_middle_name as candidate_middle_name,
    cand_hist.candidate_last_name as candidate_last_name,
    cand_hist.candidate_prefix as candidate_prefix,
    cand_hist.candidate_suffix as candidate_suffix
