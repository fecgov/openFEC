...
his is the latest version of ofec_reports_pac_party_mv
Add committee ID to tsvector column and rename column 

-- Previous mv is V0254
*/
-- -----------------------------------------------------
...
CREATE MATERIALIZED VIEW public.ofec_reports_pac_party_mv_tmp AS
    SELECT row_number() OVER () AS idx,
        ...
        rpt.committee_name,
        to_tsvector(parse_fulltext(rpt.committee_name||' '||rpt.committee_id)) AS filer_name_text    
