/*
This is migration is for issue #5902

Add original exp_dt as disbursement_dt 

Previous migration file is V0269
*/
...
to_timestamp(to_char(fr.receipt_dt, '99999999'), 'YYYYMMDD')::timestamp without time zone as receipt_dt,
true as most_recent,
ff57.exp_dt as disbursement_dt
...
most_recent,
to_tsvector(parse_fulltext(coalesce(cmte.cmte_nm,'')||' '||SE.cmte_id)) as spender_name_text,
disbursement_dt
FROM se
