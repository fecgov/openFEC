drop table if exists ofec_reports_house_senate_tmp;
create table ofec_reports_house_senate_tmp as
select
    ...
    greatest(coh_cop_i, coh_cop_ii) as cash_on_hand_end_period,
    ...
    greatest(ttl_disb_per_i, ttl_disb_per_ii) as total_disbursements_period,
    ...
    greatest(ttl_receipts_per_i, ttl_receipts_ii) as total_receipts_period,
...
create unique index on ofec_reports_house_senate_tmp(idx);

create index on ofec_reports_house_senate_tmp(cycle, idx);
create index on ofec_reports_house_senate_tmp(expire_date, idx);
create index on ofec_reports_house_senate_tmp(report_type, idx);
create index on ofec_reports_house_senate_tmp(report_year, idx);
create index on ofec_reports_house_senate_tmp(committee_id, idx);
create index on ofec_reports_house_senate_tmp(coverage_end_date, idx);
create index on ofec_reports_house_senate_tmp(coverage_start_date, idx);
create index on ofec_reports_house_senate_tmp(beginning_image_number, idx);

drop table if exists ofec_reports_house_senate;
alter table ofec_reports_house_senate_tmp rename to ofec_reports_house_senate;
