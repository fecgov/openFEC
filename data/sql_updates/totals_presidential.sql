drop table if exists ofec_totals_presidential_tmp;
create table ofec_totals_presidential_tmp as
with last as (
...
create unique index on ofec_totals_presidential_tmp(idx);

create index on ofec_totals_presidential_tmp(cycle, idx);
create index on ofec_totals_presidential_tmp(committee_id, idx);

drop table if exists ofec_totals_presidential;
alter table ofec_totals_presidential_tmp rename to ofec_totals_presidential;
