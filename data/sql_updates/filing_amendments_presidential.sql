drop table if exists temp_paper_filer_chain_presidential cascade;
drop table if exists temp_electronic_filer_chain_presidential cascade;

create table temp_electronic_filer_chain_presidential as
...
create table temp_paper_filer_chain_presidential as
...
select * from temp_electronic_filer_chain_presidential
union all select * from temp_paper_filer_chain_presidential;
