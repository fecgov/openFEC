drop table if exists ofec_reports_pacs_parties_tmp;
create table ofec_reports_pacs_parties_tmp as
select
    ...
    greatest(offsets_to_op_exp_per_i, offsets_to_op_exp_per_ii
    ) as offsets_to_operating_expenditures_period,
    greatest(offsets_to_op_exp_ytd_i, offsets_to_op_exp_ytd_ii) as offsets_to_operating_expenditures_ytd,
    ...
    greatest(ttl_contb_ref_per_i, ttl_contb_ref_per_ii) as total_contribution_refunds_period,
    greatest(ttl_contb_ref_ytd_i, ttl_contb_ref_ytd_ii) as total_contribution_refunds_ytd,
    ttl_contb_per as total_contributions_period,
    ttl_contb_ytd as total_contributions_ytd,
    greatest(ttl_disb_sum_page_per, ttl_disb_per) as total_disbursements_period,
    greatest(ttl_disb_sum_page_ytd, ttl_disb_ytd) as total_disbursements_ytd,
    ...
    greatest(ttl_receipts_sum_page_per, ttl_receipts_per) as total_receipts_period,
    greatest(ttl_receipts_sum_page_ytd, ttl_receipts_ytd) as total_receipts_ytd,
...
create unique index on ofec_reports_pacs_parties_tmp(idx);

create index on ofec_reports_pacs_parties_tmp(cycle, idx);
create index on ofec_reports_pacs_parties_tmp(expire_date, idx);
create index on ofec_reports_pacs_parties_tmp(report_type, idx);
create index on ofec_reports_pacs_parties_tmp(report_year, idx);
create index on ofec_reports_pacs_parties_tmp(committee_id, idx);
create index on ofec_reports_pacs_parties_tmp(coverage_end_date, idx);
create index on ofec_reports_pacs_parties_tmp(coverage_start_date, idx);
create index on ofec_reports_pacs_parties_tmp(beginning_image_number, idx);

drop table if exists ofec_reports_pacs_parties;
alter table ofec_reports_pacs_parties_tmp rename to ofec_reports_pacs_parties;
