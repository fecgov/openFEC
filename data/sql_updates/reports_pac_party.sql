drop materialized view if exists ofec_reports_pacs_parties_mv_tmp cascade;
...
select
    ...
    ttl_op_exp_per as offsets_to_operating_expenditures_period,
    ttl_op_exp_ytd as offsets_to_operating_expenditures_ytd,
