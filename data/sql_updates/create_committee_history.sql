...
select distinct on (fec_yr.cmte_id, fec_yr.fec_election_yr)
    ...
    org_dates.min_date as first_file_date,
    org_dates.max_date as last_file_date,
    filing_dates.max_date as last_f1_date,
...
left join org_dates on fec_yr.cmte_id = org_dates.cmte_id
left join filing_dates on fec_yr.cmte_id = filing_dates.cmte_id
