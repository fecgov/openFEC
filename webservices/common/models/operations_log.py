...
class OperationsLog(db.Model):
    ...
    beginning_image_number = db.Column('beg_image_num', db.String, doc="")
    ending_image_number = db.Column('end_image_num', db.String, doc="")
    form_type = db.Column('form_tp', db.String, doc=docs.FORM_TYPE)
    report_year = db.Column('rpt_yr', db.Integer, doc=docs.REPORT_YEAR)
    receipt_date = db.Column('receipt_dt', db.DateTime, doc="")
    coverage_start_date = db.Column('beginning_coverage_dt', db.DateTime, doc="")
    coverage_end_date = db.Column('ending_coverage_dt', db.DateTime, doc="")
