...
class OperationsLog(db.Model):
    ...
    candidate_committee_id = db.Column('cand_cmte_id', db.String,
            doc=docs.CAND_CMTE_ID)
    beginning_image_number = db.Column('beg_image_num', db.String,
    ...
    receipt_date = db.Column('receipt_dt', db.DateTime,
            doc=docs.RECEIPT_DATE)
    coverage_start_date = db.Column('beginning_coverage_dt', db.DateTime,
            doc=docs.COVERAGE_START_DATE)
    coverage_end_date = db.Column('ending_coverage_dt', db.DateTime,
