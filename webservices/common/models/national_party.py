...
class NationalParty_ScheduleA(db.Model):
    ...
    committee_contributor_name = db.Column('cmte_contbr', db.String)
    committee_contributor_designation = db.Column('cmte_contbr_desgn', db.String)
    committee_contributor_designation_full = db.Column('cmte_contbr_desgn_full', db.String)
    committee_contributor_organization = db.Column('cmte_contbr_org', db.String)
    committee_contributor_organization_full = db.Column('cmte_contbr_org_full', db.String)
    committee_contributor_party = db.Column('cmte_contbr_party', db.String)
    committee_contributor_party_full = db.Column('cmte_contbr_party_full', db.String)
    committee_contributor_state = db.Column('cmte_contbr_state', db.String)
    committee_contributor_state_full = db.Column('cmte_contbr_state_full', db.String)
    committee_contributor_type = db.Column('cmte_contbr_type', db.String)
    committee_contributor_type_full = db.Column('cmte_contbr_type_full', db.String)
    ...
    party_account_receipt_type = db.Column('receipt_tp', db.String)
...
class NationalParty_ScheduleB(db.Model):
    ...
    clean_recipient_cmte_id = db.Column('clean_recipient_cmte_id', db.String)
    cmte_as_recipient = db.Column('cmte_as_recipient', db.String)
    cmte_as_recipient_desgn = db.Column('cmte_as_recipient_desgn', db.String)
    cmte_as_recipient_desgn_full = db.Column('cmte_as_recipient_desgn_full', db.String)
    cmte_as_recipient_org = db.Column('cmte_as_recipient_org', db.String)
    cmte_as_recipient_org_full = db.Column('cmte_as_recipient_org_full', db.String)
    cmte_as_recipient_party = db.Column('cmte_as_recipient_party', db.String)
    cmte_as_recipient_party_full = db.Column('cmte_as_recipient_party_full', db.String)
    cmte_as_recipient_state = db.Column('cmte_as_recipient_state', db.String)
    cmte_as_recipient_state_full = db.Column('cmte_as_recipient_state_full', db.String)
    cmte_as_recipient_type = db.Column('cmte_as_recipient_type', db.String)
    cmte_as_recipient_type_full = db.Column('cmte_as_recipient_type_full', db.String)
    committee_designation = db.Column('cmte_dsgn', db.String)
    committee_id = db.Column('cmte_id', db.String(9), doc=docs.COMMITTEE_ID)
    committee_name = db.Column('cmte_nm', db.String, doc=docs.COMMITTEE_NAME)
    comm_dt = db.Column(db.Date)
    recipient_committee_type = db.Column('cmte_tp', db.String, doc=docs.COMMITTEE_TYPE)
    ...
    recipient_committee_designation = db.Column('designation', db.String)
    recipient_committee_designation_full = db.Column('designation_full', db.String)
    disbursement_amount = db.Column('disb_amt', db.Numeric)
    disbursement_desc = db.Column('disb_desc', db.String)
    disb_date = db.Column('disb_dt', db.String)
    disb_type = db.Column('disb_tp', db.String)
    disb_tp_desc = db.Column('disb_tp_desc', db.String)
    disbursement_description_text = db.Column(db.String)
    ...
    entity_type_desc = db.Column('entity_tp_desc', db.String)
    fec_election_type_desc = db.Column('fec_election_tp_desc', db.String)
    fec_election_type_year = db.Column('fec_election_tp_yr', db.String)
    file_number = db.Column('file_num', db.Numeric)
    filing_form = db.Column(db.String)
    filing_frequency = db.Column(db.String)
    image_number = db.Column('image_num', db.String(18), index=True, doc=docs.IMAGE_NUMBER)
    ...
    recipient_cmte_id = db.Column('recipient_cmte_id', db.String)
