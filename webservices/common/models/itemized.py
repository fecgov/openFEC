...
class Form56(db.Model):
    ...
    entity_type = db.Column('entity_type', db.String, index=True)
    entity_type_desc = db.Column('entity', db.String)
...
class ScheduleD(PdfMixin, BaseItemized):
    ...
    committee_type = db.Column('cmte_tp', db.String, index=True, doc=docs.COMMITTEE_TYPE)
    filing_form = db.Column('filing_form', db.String, index=True, doc=docs.FORM_TYPE)
