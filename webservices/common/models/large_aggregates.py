...
class EntityRecieptsTotals(db.Model):
    """two year receipt totals by entity type and two-year election period"""
    __tablename__ = 'entity_reciepts_chart'
    ...
    reciepts = db.Column('adjusted_total_reciepts', db.Float, doc="Total adjusted receipts for that entity type")
