...
class ElectioneeringCost(db.Model):
    ...
    form_type = db.Column('form_tp', db.String, index=True)
    committee_id = db.Column('filer_cmte_id', db.String, index=True)
    ...
    beginning_image_number = db.Column('begin_image_num', db.String, index=True)
    ...
    disbursement_amount = db.Column('disb_amt', db.Numeric(30, 2), index=True)
