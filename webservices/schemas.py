...
class TotalByOfficeSchema(ma.Schema):
    total_receipt = ma.fields.Decimal(places=2)
    total_disbursement = ma.fields.Decimal(places=2)
augment_schemas(TotalByOfficeSchema)
# TotalByOfficePageSchema = make_page_schema(TotalByOfficeSchema)
# register_schema(TotalByOfficeSchema)
# register_schema(TotalByOfficePageSchema)
