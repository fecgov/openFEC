...
ScheduleECandidateStateTotalsSchema = make_schema(
    models.ScheduleECandidateStateTotals,
    options={'exclude': ('idx',)}
)
ScheduleECandidateStateTotalsPageSchema = make_page_schema(
    ScheduleECandidateStateTotalsSchema
)
register_schema(ScheduleECandidateStateTotalsSchema)
register_schema(ScheduleECandidateStateTotalsPageSchema)
