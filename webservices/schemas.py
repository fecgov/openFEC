...
class ElectionSchema(ma.Schema):
    candidate_id = ma.fields.Str(attribute='CandidateHistory.candidate_id')
    candidate_name = ma.fields.Str(attribute='CandidateHistory.name')
    candidate_status_full = ma.fields.Str(attribute='CandidateHistory.candidate_status_full')
    total_receipts = ma.fields.Int(attribute='Filings.total_receipts')
    total_disbursements = ma.fields.Decimal(attribute='Filings.total_disbursements')
    cash_on_hand_end_period = ma.fields.Decimal(attribute='Filings.cash_on_hand_end_period')
    document_description = ma.fields.Str(attribute='Filings.document_description')
    pdf_url = ma.fields.Str(attribute='Filings.pdf_url')
