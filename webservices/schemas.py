...
AuditCaseSearchByCategoryIdSchema = make_schema(
    ...
    options={
        'exclude': ('primary_category_id', 'sub_category_id')
    }
)
AuditCaseSearchByCategoryIdPageSchema = make_page_schema(AuditCaseSearchByCategoryIdSchema)
register_schema(AuditCaseSearchByCategoryIdSchema)
register_schema(AuditCaseSearchByCategoryIdPageSchema)
