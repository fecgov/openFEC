...
from webservices.calendar_utils import format_start_date, format_end_date
...
NationalPartyScheduleAPageSchema = make_page_schema(
   NationalPartyScheduleASchema
)
register_schema(NationalPartyScheduleASchema)
register_schema(NationalPartyScheduleAPageSchema)
...
NationalPartyScheduleBPageSchema = make_page_schema(
   NationalPartyScheduleBSchema
)
register_schema(NationalPartyScheduleBSchema)
register_schema(NationalPartyScheduleBPageSchema)
# National_Party schema - End
...
register_schema(NationalPartyTotalsSchema)
register_schema(NationalPartyTotalsPageSchema)
# NationalPartyTotals schema - End
