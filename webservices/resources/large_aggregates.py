...
@doc(tags=['financial'], description=docs.ENTITY_RECEIPTS_TOTLAS)
class EntityReceiptDisbursementTotalsView(ApiResource):
    ...
    filter_match_fields = [('cycle', model.cycle)]
    ...
    def args(self):
        return utils.extend(
            ...
            args.make_sort_args(
                default='end_date', validator=args.OptionValidator(['end_date'])
            ),
        )
