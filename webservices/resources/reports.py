...
reports_model_map = {
    ...
    'H': (CommitteeReportsHouseOrSenate, house_senate_fields),
    'S': (CommitteeReportsHouseOrSenate, house_senate_fields),
    'default': (CommitteeReportsPacOrParty, pac_party_fields),
}
