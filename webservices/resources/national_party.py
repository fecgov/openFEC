...
class NationalParty_ScheduleBView(ApiResource):
    ...
    filter_multi_fields = [
        ...
        ('recipient_committee_type', models.NationalParty_ScheduleB.recipient_committee_type),
        ('recipient_committee_designation', models.NationalParty_ScheduleB.recipient_committee_designation),
