...
api.add_resource(large_aggregates.EntityRecieptsTotalsView, '/totals/entity-receipts/')
...
apidoc.register(large_aggregates.EntityRecieptsTotalsView, blueprint='v1')
