...
def get_graph():
    ...
    graph.add_edges_from(
        [('candidate_history', 'filings'), ('committee_history', 'filings')]
    )
    ...
    graph.add_edges_from([('totals_combined', 'sched_a_by_size_merged')])
    ...
    graph.add_edges_from(
        [('filings', 'totals_combined'), ('filings', 'report_pac_party_all')]
    )
