...
reports = {
    ...
    'committee_ids': fields.List(fields.Str, description=docs.COMMITTEE_ID),
    'min_disbursements_amount': Currency(description='Filter for all amounts greater than a value.'),
    ...
    'auth_committee_candidate_id': fields.List(fields.Str, description=docs.CANDIDATE_ID),
}
