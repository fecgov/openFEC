...
#from marshmallow.utils import text_type
...
query = {
    ...
    'case_respondents': fields.List(IStr, required=False, description='Filter cases by respondents'),
    'case_dispositions': fields.List(IStr, required=False, description='Filter cases by dispositions'),
    'case_election_cycles': fields.List(IStr, required=False, description='Filter cases by election cycles'),
    ...
    'af_committee_id': fields.List(IStr, required=False, description='Admin fine committee ID'),
    'af_report_year': fields.List(IStr, required=False, description='Admin fine report year'),
    ...
    'af_rtb_fine_amount': fields.List(IStr, required=False, description='Filter cases by Reason to Believe fine amount'),
    ...
    'af_fd_fine_amount': fields.List(IStr, required=False, description='Filter cases by Final Determination fine amount')
}
...
electioneering = {
    ...
    'description': fields.Str(description='Disbursement description'),
}
